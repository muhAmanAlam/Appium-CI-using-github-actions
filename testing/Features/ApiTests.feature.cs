...
namespace testing.Features
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("Testinng the Postman-Echo API", Description="A short summary of the feature", SourceFile="Features\\ApiTests.feature", SourceLine=0)]
